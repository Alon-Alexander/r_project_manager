---
title: "Defining Project Inputs: Different Formats for project.yaml"
...
The `project.yaml` file defines the inputs for your project in a portable way. This file can be written in several formats, from simple lists to detailed definitions with metadata. This vignette demonstrates all the supported formats.
