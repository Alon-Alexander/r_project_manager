---
title: "Defining Project Inputs: Different Input Formats for project.yaml"
...
The `project.yaml` file defines the configuration for your project.
An important part for this is defining the inputs for your project in a portable way. This file can be written in several formats, from simple lists to detailed definitions with metadata. This vignette demonstrates all the supported formats.
...
yaml::write_yaml(inputs_yaml, file.path(project_dir, "project.yaml"))
